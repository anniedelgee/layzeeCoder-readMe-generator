...
// use conditional statements to generate table of contents depending on what information has been provided by the user

function generateMarkdown(userResponses) {
  
  let tableOfContents= '## Table of Contents' ;

  if (userResponses.title !== '') { tableOfContents +=
    ` * [Project Title](#title)`};
